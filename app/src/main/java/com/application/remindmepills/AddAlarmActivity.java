...
//		timePicker.setCurrentMinute(state.getInt("min"));
	...
	protected void onResume() {
		super.onResume();
		sdf.applyPattern(RemindMePills.getDateFormat());
	}
	...
	protected Dialog onCreateDialog(final int id) {
		...
		case DIALOG_ATTIME:
			...
			return new TimePickerDialog(this, mTimeSetListener, cal.get(Calendar.HOUR_OF_DAY), cal.get(Calendar.MINUTE), RemindMePills.is24Hours());
