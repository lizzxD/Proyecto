...
//	private static final String TAG = "SettingsActivity";
	...
	private void updatePreferences() {
		updatePreference(RemindMePills.TIME_OPTION);
		updatePreference(RemindMePills.DATE_RANGE);
		updatePreference(RemindMePills.DATE_FORMAT);
		updatePreference(RemindMePills.RINGTONE_PREF);
	}
...
/*		if (pref instanceof EditTextPreference){
	    ...
	    if (RemindMePills.RINGTONE_PREF.equals(key)) {
	    	Uri ringtoneUri = Uri.parse(RemindMePills.getRingtone());
